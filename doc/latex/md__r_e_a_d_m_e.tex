...
// define usable options for this program, also set default values opt.\-add\-\_\-flag(\char`\"{}all\char`\"{}, 'a', \char`\"{}\-List all stuffs.\char`\"{}); opt.\-add\-\_\-option\-\_\-str(\char`\"{}input-\/file\char`\"{}, 'i', \char`\"{}-\/\char`\"{}, \char`\"{}=\-F\-I\-L\-E Input filename, default is -\/.\char`\"{}); opt.\-add\-\_\-option\-\_\-int(\char`\"{}buffer-\/size\char`\"{}, 'b', 100, \char`\"{}=\-S\-I\-Z\-E Set the buffer size, default is 100.\char`\"{}); opt.\-add\-\_\-option\-\_\-double(\char`\"{}min\char`\"{}, 0, 0.\-9, \char`\"{}=\-F\-L\-O\-A\-T Minimal correlation coefficient, default is 0.\-9.\char`\"{}); opt.\-add\-\_\-flag('v', \char`\"{}\-Open verbose model.\char`\"{}); opt.\-add\-\_\-flag(\char`\"{}help\char`\"{}, 'h', \char`\"{}\-Display help information.\char`\"{});

// parsing command line, collect command line arguments opt.\-parse\-\_\-argv(argc, argv);
